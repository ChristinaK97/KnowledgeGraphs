...
class BERTMapPipeline:
    ...
    def __init__(self, src_onto: Ontology, tgt_onto: Ontology, config: CfgNode):
        ...
        FileUtils.create_path(os.path.join(self.output_path,"results_per_dataset", self.config.dataset_name, self.config.mode))
        ...
        config_path = os.path.join(self.output_path,"results_per_dataset", self.config.dataset_name, self.config.mode, "config.yaml")
...
# ======================================================================================================================
    ...
    def run_predictor(self, entity_type):
        ...
        self.mapping_predictor = MappingPredictor(
            output_path=os.path.join(self.output_path,"results_per_dataset", self.config.dataset_name, self.config.mode),
...
# ======================================================================================================================
    ...
    def extractBertMapMappings(self):
        ...
        MappingSelector(
            ...
            outputFile = os.path.join(self.output_path,"results_per_dataset", self.config.dataset_name, self.config.mode, "match", "BertMapMappings.json")
        ).rawMaps
